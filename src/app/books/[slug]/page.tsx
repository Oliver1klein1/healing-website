...
export default async function BookPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <>
      ...
      <main className="min-h-screen relative bg-gradient-to-br from-blue-50 via-purple-50 to-blue-50">
        {/* Decorative background elements */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-200/30 via-purple-200/30 to-transparent pointer-events-none"></div>
        <div className="absolute inset-0 bg-[url('/grid.png')] opacity-30 pointer-events-none"></div>
